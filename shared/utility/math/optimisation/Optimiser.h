...
namespace math {
    namespace optimisation {
        ...
        public:
            ...
            virtual OptimiserEstimate updateEstimate(Eigen::MatrixXd samples, Eigen::VectorXd fitnesses) = 0;
            virtual Eigen::MatrixXd getSamples(const uint& numSamples = 7) = 0;
        ...
        public:
             ...
             * @author Josiah Walker
             */
            virtual OptimiserEstimate updateEstimate(Eigen::MatrixXd samples, Eigen::VectorXd fitnesses) {
             ...
             * @author Josiah walker
             */
            virtual Eigen::MatrixXd getSamples(const uint& numSamples = 7) {
            ...
            std::pair<Eigen::MatrixXd,Eigen::MatrixXd> getInternalData() {
                return;
            }

            void setInternalData(const Eigen::MatrixXd& optData, const Eigen::MatrixXd& sampleData) {
                return;
            }*/
        };
