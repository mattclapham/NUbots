...
#ifndef MODULES_VISION_MARKERDETECTOR_H
#define MODULES_VISION_MARKERDETECTOR_H
...
namespace vision {
    ...
    class MarkerDetector : public NUClear::Reactor {
    private:
    ...
    public:
        ...
        static constexpr const char* CONFIGURATION_PATH = "MarkerDetector.yaml";

        /// @brief Called by the powerplant to build and setup the GoalDetector reactor.
        explicit MarkerDetector(std::unique_ptr<NUClear::Environment> environment);
    };
