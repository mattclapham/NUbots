...
namespace behaviour {
    namespace strategy {
        ...
        private:
            ...
            // TODO: unhack
            NUClear::clock::time_point ballLastMeasured = NUClear::clock::now() - std::chrono::seconds(600);
            ...
            Eigen::Vector2d getKickPlan(const std::vector<message::localisation::Self>& selfs,
