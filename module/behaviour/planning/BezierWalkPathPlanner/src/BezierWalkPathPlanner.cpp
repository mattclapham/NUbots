                ...
                .then(
                    ...
                    [this](const LocalisationBall& ball,
                        ...
                        if (latestCommand.type == MotionCommand::Type::StandStill) {
                            ...
                            emit(drawSphere(
                                "Tangent 1", Eigen::Vector3d(B1, A1, 0.0), 0.1, Eigen::Vector3d(0, 1, 0), 0));
                            emit(drawSphere(
                                "Tangent 2", Eigen::Vector3d(B2, A2, 0.0), 0.1, Eigen::Vector3d(0, 0, 1), 0));
                            ...
                            bez_matrix << bezier_X_point, bezier_Y_point, A0, B0;
                            ...
                            int turning_point[6];
                            for (int i=0;i<6;i++) {
                                int turning_point[i] = distance(radius_of_curvature, misize()ent(radius_of_curvature,
