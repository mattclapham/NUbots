...
namespace support {
    ...
    Eigen::Vector2d VirtualGoalPost::getCamRay(const Eigen::Vector3d& norm1,
        ...
        return utility::math::vision::screenToImage(utility::math::vision::projectCamSpaceToScreen(result, focalLength),
                                                    imSize)
            .cast<double>();
    }
    ...
    Goal VirtualGoalPost::detect(const CameraParameters& camParams,
        ...
        Hgt.topRightCorner<3, 1>().setZero();
        ...
        if ((goalNormals.array() > 0.0).any()) {
            ...
            utility::math::geometry::Quad quad(
                getCamRay(
                    goalNormals.col(0), goalNormals.col(3), camParams.focalLengthPixels, camParams.imageSizePixels),
                getCamRay(
                    goalNormals.col(0), goalNormals.col(2), camParams.focalLengthPixels, camParams.imageSizePixels),
                getCamRay(
                    goalNormals.col(1), goalNormals.col(2), camParams.focalLengthPixels, camParams.imageSizePixels),
                getCamRay(
                    goalNormals.col(1), goalNormals.col(3), camParams.focalLengthPixels, camParams.imageSizePixels));
