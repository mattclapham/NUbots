...
namespace motion {
    ...
    void OldWalkEngine::calculateNewStep() {
        ...
        zmpCoefficients.head<2>() = zmpSolve(uSupport.x(),
                                             uTorsoSource.x(),
                                             uTorsoDestination.x(),
                                             uTorsoSource.x(),
                                             uTorsoDestination.x(),
                                             ...
                                             stepTime,
                                             zmpTime);
        zmpCoefficients.tail<2>() = zmpSolve(uSupport.y(),
                                             uTorsoSource.y(),
                                             uTorsoDestination.y(),
                                             uTorsoSource.y(),
                                             uTorsoDestination.y(),
    ...
    Transform2D OldWalkEngine::getNewFootTarget(const Transform2D& velocity,
        ...
        double overlap     = kinematicsModel.leg.FOOT_LENGTH * 0.5 * std::abs(feetDifference.angle());
