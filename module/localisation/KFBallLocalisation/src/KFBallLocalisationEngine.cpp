...
namespace localisation {
    ...
    double KFBallLocalisationEngine::MeasurementUpdate(const VisionObject& observed_object) {
        ...
        for (auto& measurement : observed_object.measurements) {
            ...
            Eigen::Vector2d cartesianImuObservation2d =
                observed_object.sensors->robotToIMU * measuredPosCartesian.rows(0, 1);
            Eigen::Vector3d cartesianImuObservation =
                Eigen::Vector3d(cartesianImuObservation2d(0), cartesianImuObservation2d(1), measuredPosCartesian(2));
