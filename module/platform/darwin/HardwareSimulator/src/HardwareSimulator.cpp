    ...
    namespace darwin {
        ...
        HardwareSimulator::HardwareSimulator(std::unique_ptr<NUClear::Environment> environment)
            ...
            on<Every<UPDATE_FREQUENCY, Per<std::chrono::seconds>>, Optional<With<Sensors>>, Single>().then([this](
                ...
                // std::cout << "HardwareSimulator gyroscope = " << sensors.gyroscope.x << ", " << sensors.gyroscope.y
                // << ", " << sensors.gyroscope.z << std::endl;
                // std::cout << "HardwareSimulator integrated_gyroscope = " << integrated_gyroscope.transpose() <<
                // std::endl;
